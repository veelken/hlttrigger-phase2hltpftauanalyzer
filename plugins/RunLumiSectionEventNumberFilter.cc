#include "HLTTrigger/TallinnHLTPFTauAnalyzer/plugins/RunLumiSectionEventNumberFilter.h"
...
//--- read run + luminosity section + event number pairs from ASCII file
  ...
  std::ifstream runLumiSectionEventNumberFile(runLumiSectionEventNumberFileName_.data());
  int iLine = 0;
