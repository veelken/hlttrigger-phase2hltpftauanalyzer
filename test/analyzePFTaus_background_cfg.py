...
outputFileName = "analyzePFTaus_background_%s_2020Jun24.root" % processName
...
for algorithm in [ "hps", "shrinking-cone" ]:
  ...
  module_PFTauAnalyzerBackground = cms.EDAnalyzer("RecoPFTauAnalyzerBackground",
    ...
    dqmDirectory = cms.string("%s/%sAnalyzerBackground%s" % (processName, pfTauLabel, suffix))
  )
  ...
  module_PFTauPairAnalyzer = cms.EDAnalyzer("RecoPFTauPairAnalyzer",
    ...
    lumiScale = cms.double(lumiScale),
    dqmDirectory = cms.string("%s/%sPairAnalyzer%s" % (processName, pfTauLabel, suffix))
  )
  ...
  module_PFTauIsolationAnalyzer = cms.EDAnalyzer("RecoPFTauIsolationAnalyzer",
    ...
    lumiScale = cms.double(lumiScale),                    
    dqmDirectory = cms.string("%s/%sIsolationAnalyzer%s" % (processName, pfTauLabel, suffix))
  )
